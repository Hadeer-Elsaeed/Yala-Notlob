...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { Group_id: @friendship.Group_id, User_id: @friendship.User_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { Group_id: @friendship.Group_id, User_id: @friendship.User_id } }
